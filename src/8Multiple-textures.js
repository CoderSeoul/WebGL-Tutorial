...
const attributeLocations = {
    ...
    texCoords: gl.getAttribLocation(program, 'texCoord'),
...
gl.vertexAttribPointer(attributeLocations.texCoords, 2, gl.FLOAT, false, 0, 0);
...
Promise.all([
    ...
    gl.uniform2fv(uniformLocations.otherTexture, [canvas.width, canvas.height]);
